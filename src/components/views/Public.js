...
export default function Public() {
  ...
  function onSubmit5(e){
    ...
    searchPrivate.classList.add("d-none");
      ...
      exportPrivate.classList.add("d-none");

      var exportPublic = document.getElementById('exportPublic');
      exportPublic.classList.remove("d-none");
    ...
    useEffect(() => {
      ...
      return () => {
        dispatch(removeLayer(PUBLIC_INNOVATIONS_LAYER_ID));
          ...
          <div className="card d-md-none">
            ...
            <div className="card-header" style={background_white}>
              <a className="card-link text-dark" style={card_header} data-toggle="collapse" href="#collapse3">
                ...
                {/* <input type="text" className=" ml-1 form-control" style={searchStyle} onChange={onSubmit5Public} placeholder="Search Innovation" ref={searchInput5Public} id='search2Public' ></input> */}
            ...
            <div id="collapseOne" className="collapse" data-parent="#accordion">
              <div className="card-body p-0 m-0">
                ...
                {/* <div className="text-center px-4">
                  <button type="button" className="btn btn-dark btn-block mx-0 px-0 my-2" data-toggle="tooltip" title="not available for public version" style={exportButton}>Export 2</button> 
                </div> */}
