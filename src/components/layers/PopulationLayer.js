  ...
  if (populationLayer && source) {
    return new CartoLayer({
      ...
      getFillColor: d => {
        ...
        if(d.properties.population_percentage_2017_census_approximated_to_2nd_decimal <= 1){
          return [224,236,244]; 
        }else if(d.properties.population_percentage_2017_census_approximated_to_2nd_decimal <= 3){
          return [158,188,218];
        }else if(d.properties.population_percentage_2017_census_approximated_to_2nd_decimal <= 7){
          return [140,107,177];
        }else if(d.properties.population_percentage_2017_census_approximated_to_2nd_decimal <= 11){
          return [129,15,124];  
        }else{
      ...
      onClick: (info, event) =>{ 
        ...
        if(document.getElementById('custom-tooltip2')){
         ...
         elem2.parentNode.removeChild(elem2);
          ...
          .replaceAll('poverty_percentage_2017_2018','Overall Percentage')
          .replaceAll('<strong>governorate</strong>','<strong>Governorate</strong>')
          .replaceAll('<strong>percentage_of_urban_population_2017_census</strong>','<strong>Urban Percentage</strong>')
          .replaceAll('<strong>percentage_of_rural_population_2017_census</strong>','<strong>Rural Percentage</strong>')
