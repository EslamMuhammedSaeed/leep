      ...
      onClick: (info, event) =>{ 
        ...
        if(document.getElementById('custom-tooltip')){
         ...
         elem.parentNode.removeChild(elem);
          ...
          .replaceAll('dropout_percentage_in_primary_education_2017_2018_2018_2019','Overall Percentage')
          .replaceAll('<strong>governorate</strong>','<strong>Governorate</strong>')
          .replaceAll('<strong>male_dropout_percentage_in_primary_education_2017_2018_2018_201</strong>','<strong>Male Percentage</strong>')
          .replaceAll('<strong>female_dropout_percentage_in_primary_education_2017_2018_2018_2</strong>','<strong>Female Percentage</strong>')
