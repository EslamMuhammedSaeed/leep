      ...
      onClick: (info, event) =>{ 
        ...
        if(document.getElementById('custom-tooltip')){
         ...
         elem.parentNode.removeChild(elem);
          ...
          .replaceAll('illiteracy_percentage_2017_census','Illiteracy Percentage (2017 Census)')
          .replaceAll('<strong>governorate</strong>','<strong>Governorate</strong>')
          .replaceAll('<strong>male_illiteracy_percentage_2017_census</strong>','<strong>Male Illiteracy Percentage (2017 Census)</strong>')
          .replaceAll('<strong>female_illiteracy_percentage_2017_census</strong>','<strong>Female Illiteracy Percentage (2017 Census)</strong>')
