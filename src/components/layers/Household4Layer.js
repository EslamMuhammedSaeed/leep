...
const layerConfig = {
  ...
  switchable: false,
  legend: {
    attr: '% Average Number of Lines / 1000 Households',
      ...
      onClick: (info, event) =>{ 
        ...
        if(document.getElementById('custom-tooltip')){
         ...
         elem.parentNode.removeChild(elem);
          ...
          .replaceAll('average_number_of_home_phone_lines_1000_households_2019_2020','Average Number of Lines / 1000 Households')
